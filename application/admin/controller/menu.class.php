...
class menu extends common {
	...
	public function init() {
		...
		$array = array();
		foreach($data as $v) {
			$v['string'] = '<a title="增加子类" href="javascript:;" onclick="yzm_open(\'增加菜单\',\''.U('add',array('parentid'=>$v['id'])).'\',800,500)" style="text-decoration:none">增加子类</a> | <a title="编辑菜单" href="javascript:;" onclick="yzm_open(\'编辑菜单\',\''.U('edit',array('id'=>$v['id'])).'\',800,500)" style="text-decoration:none">编辑</a> | <a title="删除" href="javascript:;" onclick="yzm_del(\''.U('delete',array('id'=>$v['id'])).'\')" style="text-decoration:none">删除</a>';
